...
var neighborhoodSentence = (city, neighborhood) => `${neighborhood}: contractors here need pages that connect ${city.nuance.toLowerCase().split(".")[0]} to a fast call path, proof, and service-area clarity.`;
var cityPage = (seed) => {
